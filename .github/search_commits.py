...
def parser():
    ...
    parser.add_argument('--commit_before_merge', type=str, required=True, help='Git commit ID to start labeling from newest commit.')
    parser.add_argument('--commit_after_merge', type=str, required=True, help='Git commit ID to end labeling at (oldest commit, exclusive).')
